...
export var Option = function (_a) {
    ...
    var _b = useContext(SelectContext), onSelect = _b.onSelect, selectedValues = _b.selectedValues, multiple = _b.multiple, selectedValue = _b.selectedValue;
    var isSelected = multiple ? selectedValues.includes(value) : value === selectedValue;
    var classes = classNames('al-select-item', {
