...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "al-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "al-upload-list-item", key: item.uid },
