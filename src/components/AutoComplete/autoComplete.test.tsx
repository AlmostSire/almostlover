...
describe('test AutoComplete component', () => {
    ...
    it('test basic AutoComplete behavior', async () => {
        ...
        expect(wrapper.container.querySelectorAll('.al-suggestion-item').length).toEqual(2)
    ...
    it('should provide keyboard support', async () => {
        ...
        expect(firstResult).toHaveClass('al-suggestion-item-lighted')
        fireEvent.keyDown(inputNode, { keyCode: 40 })
        expect(secondResult).toHaveClass('al-suggestion-item-lighted')
        // arrow up
